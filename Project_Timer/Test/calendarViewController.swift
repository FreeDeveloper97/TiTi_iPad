...
extension calendarViewController {
    func setCalendar() {
        ...
        calendar.appearance.headerTitleFont = UIFont(name: "HGGGothicssiP60g", size: 35)
        calendar.appearance.weekdayFont = UIFont(name: "HGGGothicssiP60g", size: 20)
        calendar.appearance.titleFont = UIFont(name: "HGGGothicssiP60g", size: 30)
    }

...
//        dumy.updateValue(3600, forKey: "TiTi develop")
    ...
    func getDumyDaily() -> Daily {
        ...
        let tempDay: Date = formatter.date(from: "2021.07.12")!
        daily.day = tempDay
        return daily
    }
